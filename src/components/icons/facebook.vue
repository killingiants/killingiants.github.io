<template>
	<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
		<circle cx="14" cy="14" r="12.25" fill="url(#paint0_linear_238_508)"/>
		...
		<defs>
		<linearGradient id="paint0_linear_238_508" x1="14" y1="1.75" x2="14" y2="26.1773" gradientUnits="userSpaceOnUse">
